...
-- ============================================
-- ADMIN USERS POLICIES (NO RECURSION)
-- ============================================

-- Admins can view their own admin data
...
CREATE POLICY "Block client insert"
  ON admin_users FOR INSERT
  WITH CHECK (false);

-- Block UPDATE from client
CREATE POLICY "Block client update"
  ON admin_users FOR UPDATE
  USING (false)
  WITH CHECK (false);

-- Block DELETE from client
CREATE POLICY "Block client delete"
