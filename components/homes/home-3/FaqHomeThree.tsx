                    ...
                    <div className="row g-4 align-items-center">
                        ...
                        <div className="col-lg-6">
                           <div className="faq-image-2">
                                <Image src="assets/img/faq/01.png" alt="img" className="wow img-custom-anim-left" />
                                <div className="bg-shape">
                                    <Image src="assets/img/faq/bg-shape.png" alt="img" />
                                </div>
                                <div className="quote-shape float-bob-x">
                                    <Image src="assets/img/faq/quote-shape.png" alt="img" />
                                </div>
                           </div>
                        </div>
                    </div>
