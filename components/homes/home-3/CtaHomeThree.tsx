                ...
                <div className="row g-4">
                    <div className="col-xl-2 col-lg-6">
                        <div className="coureses-image float-bob-x">
                            <Image src="assets/img/courses/girl.png" alt="img" className="wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.2s" />
                            <div className="bg-shape">
                                <Image src="assets/img/courses/bg-shape.png" alt="img" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-xl-3 col-lg-6">
                        <div className="coureses-image style-2 float-bob-y">
                            <Image src="assets/img/courses/boy.png" alt="img" className="wow img-custom-anim-right" data-wow-duration="1.5s" data-wow-delay="0.4s" />
                            <div className="bg-shape">
                                <Image src="assets/img/courses/bg-shape-2.png" alt="img" />
                            </div>
                        </div>
                    </div>
                </div>
