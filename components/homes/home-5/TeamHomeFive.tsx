          ...
          <div className="row">
            ...
            >
              <div className="team-card-items">
                ...
                <div className="content">
                  <h4>
                    <Link href="/instructor-details">William K. Swanson</Link>
                  </h4>
            ...
            >
              <div className="team-card-items">
                ...
                <div className="content">
                  <h4>
                    <Link href="/instructor-details">Douglas A. Braxton</Link>
                  </h4>
                  <p>Business Instructors</p>
                </div>
              </div>
            ...
            >
              <div className="team-card-items">
                ...
                <div className="content">
                  <h4>
                    <Link href="/instructor-details">Matthew M. Moore</Link>
                  </h4>
                  <p>Business Instructors</p>
                </div>
              </div>
            ...
            >
              <div className="team-card-items">
                ...
                <div className="content">
                  <h4>
                    <Link href="/instructor-details">Bernard A. McKenzie</Link>
                  </h4>
                  <p>Business Instructors</p>
                </div>
              </div>
