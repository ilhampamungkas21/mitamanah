    ...
    <>
      <section className="cta-newsletter-section fix blue-bg">
            <div className="girl-shape animation__arryLeftRight wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.3s">
                <Image width={100} height={100} src="/assets/img/cta/girl-img.png" alt="img" />
            </div>
            <div className="shape-1">
                <Image width={100} height={100} src="/assets/img/cta/shape-1.png" alt="img" />
            </div>
            <div className="shape-2">
                <Image width={100} height={100} src="/assets/img/cta/shape-2.png" alt="img" />
            </div>
